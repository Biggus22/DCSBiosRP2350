...
#define NUM_LEDS 23          // Total number of SK6812 LEDs

WS2812 externalLeds(pio0, 0, 9, false); // Global WS2812 object for external NeoPixels on pin 9

uart_inst_t *rs485_uart = uart0;

DcsBios::RotaryEncoder1Step pltCmChaffBurstCount("PLT_CM_CHAFF_BURST_COUNT", "DEC", "INC", 23, 20);
DcsBios::RotaryEncoder1Step pltCmChaffBurstInterval("PLT_CM_CHAFF_BURST_INTERVAL", "DEC", "INC", 8, 7);
DcsBios::RotaryEncoder1Step pltCmChaffSalvoCount("PLT_CM_CHAFF_SALVO_COUNT", "DEC", "INC", 27, 26);
DcsBios::RotaryEncoder1Step pltCmChaffSalvoInterval("PLT_CM_CHAFF_SALVO_INTERVAL", "DEC", "INC", 6, 5);
DcsBios::RotaryEncoder1Step pltCmFlareBurstCount("PLT_CM_FLARE_BURST_COUNT", "DEC", "INC", 28, 29);
DcsBios::RotaryEncoder1Step pltCmFlareBurstInterval("PLT_CM_FLARE_BURST_INTERVAL", "DEC", "INC", 4, 3);
