...
WS2812 externalLeds(pio0, 0, 3, false); // Global WS2812 object for external NeoPixels on pin 9

uart_inst_t *rs485_uart = uart0;

DcsBios::Switch2Pos pltPitotHeat("PLT_PITOT_HEAT", 5);
//Rain removal snippet will go here when available
DcsBios::Switch3Pos2Pin pltElectricsGeneratorL("PLT_ELECTRICS_GENERATOR_L", 14, 15);
DcsBios::Switch3Pos2Pin pltElectricsGeneratorR("PLT_ELECTRICS_GENERATOR_R", 7, 8);
