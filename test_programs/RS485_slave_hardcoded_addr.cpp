...
int main()
{
    ...
    // --- MODIFIED CODE: HARDCODE SLAVE ADDRESS ---
    // Define your desired slave address here.
    // Must be between SLAVE_MODE_MIN (0x1) and SLAVE_MODE_MAX (0xD) from FoxConfig.h
    uint8_t boardAddress = 0xD; // Example: Set this board as slave address 5.
                                // Change this value for each unique slave board.
...
DcsBios::Switch2Pos pltIntLightFloodWhiteToggle("PLT_INT_LIGHT_FLOOD_WHITE_TOGGLE", 14);
