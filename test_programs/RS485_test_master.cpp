...
#include "hardware/pwm.h" // Include for PWM functions
...
int main() {
    ...
    // Set boardAddress to HOST_MODE to configure Pico as RS485 Master
    uint8_t boardAddress = HOST_MODE; // Changed from 0x10 to HOST_MODE
    ...
    // Initialize the RS485 UART with specified pins and baud rate
    DcsBios::init_rs485_uart(rs485_uart, UART0_TX, UART0_RX, RS485_EN, 115200);
