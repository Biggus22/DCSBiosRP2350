...
DcsBios::Switch2Pos pltWpnMasterArm("PLT_WPN_MASTER_ARM", 8); // Switch for Master Arm
...
uint8_t boardAddress = 0xE;
    ...
    while (true)
    {
        ...
        sleep_ms(1); // Increased delay from sleep_us(10) to sleep_ms(1)
    }
}
